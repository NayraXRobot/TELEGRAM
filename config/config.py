...
# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "5280511188").split())
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/NayraXRobot/TELEGRAM",
)
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/shayari_dilwali2"
)  # Example:- https://t.me/shayari_dilwali2
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/shayarialfaz"
)  # Example:- https://t.me/shayarialfaz
